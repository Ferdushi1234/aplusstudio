      ...
      <section style={{ marginBottom: '-6rem' }} className="relative z-10 my-4 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
        ...
        <div className="space-y-15">
          <div
            ...
            <h2 className=" relative z-10 my-4  text-4xl tracking-tight font-extrabold text-center  text-gray-900 text-white"> A Plus Studio featured projects </h2>       
            ...
            <Link aria-label="See Projects" href="/gallery">
