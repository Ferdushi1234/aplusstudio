...
export const metadata= {
  title: 'Wallcladding | A Plus Studio',
  description: ' wall claddin of A Plus Studio | it provides the Door with good quality and it also provide the wall cladding. | Discover  unequaled  design mastery at A Plus Studio.',
}
const Wallcladding = () => {
  return (
    <>
         <section style={{marginBottom:'20rem'}}  className=" bg-gray-200 object-cover relative  flex flex-col items-center justify-center text-center text-white py-0 px-3">
                    <div className="video-docker absolute top-0 left-0 w-full h-96 overflow-hidden">
                        ...
                        <div style={{ marginTop: '4rem' }} className="py-10  relative text-white video-content space-y-2">
                            <h1 className="font-light text-6xl">Whate is your Better choice</h1>
                            <h2 className="font-light text-3xl">with A Plus Studio</h2>
