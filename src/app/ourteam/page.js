                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="text-center mt-6">
                                ...
                                <div className="flex items-center justify-center opacity-50 hover:opacity-100
                                    ...
                                    <Link rel="canonical" href="/" className="flex rounded-full hover:bg-indigo-50 h-10 w-10">
                                        <i className="text-indigo-500 mx-auto mt-2"><FaLinkedinIn /></i>
                                    </Link>
                                    <Link rel="canonical" href="/" className="flex rounded-full hover:bg-blue-50 h-10 w-10">                                       
                                        <i  className=" text-blue-300 mx-auto mt-2"> <FaTwitter /> </i> 
                                    </Link>                               
                                    <Link rel="canonical" href="/" className="flex rounded-full hover:bg-orange-50 h-10 w-10">
